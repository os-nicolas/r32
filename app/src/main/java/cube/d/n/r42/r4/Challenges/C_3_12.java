 ...
 */
public class C_3_12 extends Challenge {
    @Override
    ...
    protected Cube privateInitChallange() {
        ...
        result.grey();
        result.get(Cube.Positions.LEFT).data[0][0] = Side.sideToColor(Cube.Positions.LEFT);
        result.get(Cube.Positions.LEFT).data[0][1] = Side.sideToColor(Cube.Positions.OUTSIDE);
        result.get(Cube.Positions.LEFT).data[0][2] = Side.sideToColor(Cube.Positions.LEFT);
        result.get(Cube.Positions.LEFT).data[1][0] = Side.sideToColor(Cube.Positions.LEFT);
        ...
        result.get(Cube.Positions.TOP).data[0][0] = Side.sideToColor(Cube.Positions.TOP);
        result.get(Cube.Positions.TOP).data[1][0] = Side.sideToColor(Cube.Positions.RIGHT);
        result.get(Cube.Positions.TOP).data[2][0] = Side.sideToColor(Cube.Positions.TOP);
        result.get(Cube.Positions.TOP).data[0][1] = Side.sideToColor(Cube.Positions.TOP);
        ...
        result.get(Cube.Positions.RIGHT).data[2][0] = Side.sideToColor(Cube.Positions.RIGHT);
        result.get(Cube.Positions.RIGHT).data[2][1] = Side.sideToColor(Cube.Positions.OUTSIDE);
        result.get(Cube.Positions.RIGHT).data[2][2] = Side.sideToColor(Cube.Positions.RIGHT);
        result.get(Cube.Positions.BOT).data[0][2] = Side.sideToColor(Cube.Positions.BOT);
        result.get(Cube.Positions.BOT).data[1][2] = Side.sideToColor(Cube.Positions.TOP);
        result.get(Cube.Positions.BOT).data[2][2] = Side.sideToColor(Cube.Positions.BOT);
        result.get(Cube.Positions.BOT).data[0][1] = Side.sideToColor(Cube.Positions.BOT);
