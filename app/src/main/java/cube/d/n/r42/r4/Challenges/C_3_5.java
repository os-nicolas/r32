 ...
 */
public class C_3_5 extends Challenge {
    @Override
    ...
    protected Cube privateInitChallange() {
        ...
        result.get(Cube.Positions.CENTER).data[0][2] = Side.sideToColor(Cube.Positions.TOP);
        result.get(Cube.Positions.LEFT).data[2][2] = Side.sideToColor(Cube.Positions.CENTER);
        result.get(Cube.Positions.BOT).data[0][0] = Side.sideToColor(Cube.Positions.RIGHT);
