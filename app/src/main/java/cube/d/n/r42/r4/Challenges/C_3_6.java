 ...
 */
public class C_3_6 extends Challenge {
    @Override
    ...
    protected Cube privateInitChallange() {
        ...
        result.get(Cube.Positions.TOP).data[0][2] = Side.sideToColor(Cube.Positions.CENTER);
        result.get(Cube.Positions.CENTER).data[0][0] = Side.sideToColor(Cube.Positions.LEFT);
