...
public class C_3_11 extends Challenge {
    ...
    protected Cube privateInitChallange() {
        ...
        result.get(Cube.Positions.OUTSIDE).data[0][2] = Side.sideToColor(Cube.Positions.TOP);
        ...
        result.get(Cube.Positions.OUTSIDE).data[2][2] = Side.sideToColor(Cube.Positions.TOP);
